...
const Banner = () => {
  return (
    <section className="mb-20">
      <motion.div whileInView={{ opacity: 1, scale: 1 }} initial={{ opacity: 0, scale: 0.5 }} transition={{ duration: 0.5 }} viewport={{ once: true }} style={{backgroundImage: "url(/code.jpg)"}} className="w-[90%] mx-auto text-black bg-cover relative z-10">
